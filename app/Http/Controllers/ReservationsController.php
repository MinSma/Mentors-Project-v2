...
class ReservationsController extends Controller
{
    ...
    public function store(Appointment $appointment)
    {
        ...
        if ($id != null) {
            $doesHaveReservation = $this->reservationsRepository->model()::where('mentor_id',
                $mentor['id'])->where('student_id', $id)->first();
            ...
            if ($doesHaveReservation == null) {
                ...
                return redirect()->back()->with('status',
                    'Nepavyko užsiregistruoti į mentoriaus užsiėmimus, Jūs jau esate užsiregistravę pas šį mentorių');
            }
        ...
        return redirect()->back()->with('status',
            'Nepavyko užsiregistruoti į mentoriaus užsiėmimus, Jūs nesate studentas');
    }
    ...
    public function unstore(Mentor $mentor)
    {
        ...
        return redirect()->back()->with('status',
            'Nepavyko išsiregistruoti iš mentoriaus užsiėmimų, jūs nebuvote prisiregistravęs');
    }

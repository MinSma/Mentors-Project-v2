...
<div class="container lower">
    <div class="row">
        @foreach($lessons as $mentor)
            @foreach($mentor as $lesson)
                    ...
                    <div class="well well-sm">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-8 col-md-7">
                                ...
                                <small><cite title="{{ $lesson->city }}">{{ $lesson->city }} <i
                                ...
                                <p>
                                    ...
                                    <i class="glyphicon glyphicon-globe"></i><span
                                            class="orange">{{ $lesson->gender }}</span>
                                    <br/>
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-small btn-info orange-bg"
                                       href="{{ URL::to('lesson/' . $lesson->id ) }}">Profilis</a>
                                </div>
